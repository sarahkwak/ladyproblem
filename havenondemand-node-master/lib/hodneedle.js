...
HODClient.prototype.post = function(handler,arg1,arg2,arg3) {
...
HODClient.prototype.get = function(handler,arg1,arg2,arg3) {
  var args=  parseArgs(arg1,arg2,arg3)
  var data= args.data;
  var callback= args.callback;
  var async=args.async;
  ...
  var url = constructGetUrl(this.endpoint, async_string, handler, data)
  if (typeof callback == "undefined") {
    if (this.proxy != undefined) {
...
constructGetUrl = function(endpoint, asyncString, apiHandler, apiData) {
  var formatedUrl = util.format(endpoint, asyncString, apiHandler);
  var counter = 0;
  for (var key in apiData) {
    counter += 1;
    if (counter == 1) {
      formatedUrl +=  "?" + key + "=" + apiData[key];
    } else {
      formatedUrl += "&" + key + "=" + apiData[key];
    }
  }
  return encodeURI(formatedUrl);
}
